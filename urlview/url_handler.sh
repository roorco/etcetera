...
https_prgs="/usr/X11R6/bin/luakit:XW /usr/bin/links:XT"
http_prgs="/usr/bin/luakit:XW"
mailto_prgs="/usr/bin/mutt:VT /usr/bin/elm:VT /usr/bin/pine:VT /usr/bin/mail:VT"
gopher_prgs="/usr/bin/links:XT /usr/bin/luakit:XT"
ftp_prgs="/usr/bin/links:XT /usr/bin/luakit:XT"
